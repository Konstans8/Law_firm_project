  ...
  return (
    <>
      ...
      <div className={styles.hero}>
        <img className={styles.image} src="/page4/main_4.png" alt="Logo" />
        <img className={styles.image_media_1024} src="/page4/main_4media1200.png" alt="Main cover" />
        <img className={styles.image_media_768} src="/page4/main_4media768.png" alt="Main cover" />
      ...
      <div className={styles.info}>
        ...
        <div className={styles.image}>
            <img className={styles.info_img} src="/page4/info_page4.png" alt="law lady"/>
        </div>
      ...
      <dir className={styles.persons}>
        ...
        <div className={styles.persons_container}>
          <div className={styles.person}>
            <img src="/page4/face4.png" alt="man" />
          ...
          <div className={styles.person}>
            <img src="/page4/face3.png" alt="man" />
            <div className={styles.person_info}>
          ...
          <div className={styles.person}>
            <img src="/page4/face2.png" alt="man" />
            <div className={styles.person_info}>
          ...
          <div className={styles.person}>
            <img src="/page4/face1.png" alt="man" />
            <div className={styles.person_info}>
